...
# model=mlflow.pyfunc.load_model(model_uri='models:/Model_Detection_Cancer/1')
...
# model_uri="models:/Model_Detection_Cancer/1"
# )



model = mlflow.pyfunc.load_model(
    "/app/mlruns/2/models/m-1e47b3ddded24cf3a4632d77fc89d862/artifacts"
)
